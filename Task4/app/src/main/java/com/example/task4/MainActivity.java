    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnCreateCar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                countvehicle++;
                String heading = "Vehicle counted: " + countvehicle + "\n";
